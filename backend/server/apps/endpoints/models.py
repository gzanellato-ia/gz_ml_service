...
class Endpoint(models.Model):   # to keep information about our endpoints, gz
    '''
...
class MLAlgorithm(models.Model):   # to keep information about ML algorithms used in the service, gz
    '''
...
class MLAlgorithmStatus(models.Model):   # o keep information about ML algorithm statuses.
	                                     # The status can change in time, for example, we can set testing as initial status
	                                     # and then after testing period switch to production state, gz
    '''
...
class MLRequest(models.Model):   # to keep information about all requests to ML algorithms. It will be
	                             # needed to monitor ML algorithms and run A/B tests, gz
    '''
